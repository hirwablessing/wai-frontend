    ...
    <div className="lg:flex gap-12 mx-auto lg:w-2/3 p-5 my-3">
        ...
        <div className="bg-white w-full">
            ...
            <form onSubmit={ handleSubmit((data) => { handleForm(data) })}>
                <div className="title  text-gray-500 text-xl my-5"> <div className="font-bold my-5 uppercase"> Contact us form</div>
                ...
                <div>
                    {loading?
         <button type="submit" className="btn bg-yellow-400 px-4 py-3 text-white float-right my-5 focus:outline-none flex gap-2 items-center"><LoadingOutlined />Submitting</button>:
         <button type="submit" className="btn bg-yellow-500 px-4 py-3 text-white float-right my-5 focus:outline-none">Submit</button>
                }
