            ...
            <div className="bg-white rounded-lg mt-3 p-5">
                <div className="w-full">
                    <div className="form-group flex gap-5 items-center">
                        ...
                        <input type="text" onChange={(e) => { setSearch(e.target.value) }} name="" id="" className="my-5 lg:my-0 border px-3 py-2 focus:outline-none focus:ring-1 focus:border-none focus:ring-blue-500" placeholder="Search ..." />
                        {/* <Link to="/payment/add-title" className="btn bg-blue-500 text-white px-3 py-2 rounded hover:bg-blue-600">Add payment title</Link> */}
