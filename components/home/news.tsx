...
export default function news(props:any){
  const router = useRouter();
    return(
        <div>
            <div className="title text-xl font-bold text-yellow ml-5 lg:ml-12 my-5 uppercase">{props.title}</div>
  <div className="w-full p-1 gap-12 lg:flex px-5 lg:px-12 my-5 lg:my-12">
    <div className="card mt-5 lg:mt-0 border hover:border-yellow p-7 cursor-pointer" onClick={()=>router.push('/article')}>
